...
PS.TSS@sam_data$E_fer[PS.TSS@sam_data$Eimeria_ferrisi_asv>0] <- 1
PS.TSS@sam_data$E_fer[PS.TSS@sam_data$Eimeria_ferrisi_asv==0] <- 0
PS.TSS@sam_data$E_fal[PS.TSS@sam_data$Eimeria_falciformis_asv>0] <- 1
PS.TSS@sam_data$E_fal[PS.TSS@sam_data$Eimeria_falciformis_asv==0] <- 0
PS.TSS@sam_data$E_ver[PS.TSS@sam_data$Eimeria_vermiformis_asv>0] <- 1
PS.TSS@sam_data$E_ver[PS.TSS@sam_data$Eimeria_vermiformis_asv==0] <- 0
PS.TSS@sam_data$cryp[PS.TSS@sam_data$Crypto_asv>0] <- 1
PS.TSS@sam_data$cryp[PS.TSS@sam_data$Crypto_asv==0] <- 0
PS.TSS@sam_data$aspi[PS.TSS@sam_data$Aspiculuris_asv==0] <- 0
PS.TSS@sam_data$aspi[PS.TSS@sam_data$Aspiculuris_asv>0] <- 1
PS.TSS@sam_data$syph[PS.TSS@sam_data$Syphacia_asv>0] <- 1
PS.TSS@sam_data$syph[PS.TSS@sam_data$Syphacia_asv==0] <- 0
PS.TSS@sam_data$tri[PS.TSS@sam_data$Tritrichomonas_asv>0] <- 1
PS.TSS@sam_data$tri[PS.TSS@sam_data$Tritrichomonas_asv==0] <- 0
PS.TSS@sam_data$mas[PS.TSS@sam_data$Mastophorus_asv>0] <- 1
PS.TSS@sam_data$mas[PS.TSS@sam_data$Mastophorus_asv==0] <- 0
PS.TSS@sam_data$tric[PS.TSS@sam_data$Trichuris_asv>0] <- 1
PS.TSS@sam_data$tric[PS.TSS@sam_data$Trichuris_asv==0] <- 0
PS.TSS@sam_data$hymn[PS.TSS@sam_data$Hymenolepis_asv>0] <- 1
PS.TSS@sam_data$hymn[PS.TSS@sam_data$Hymenolepis_asv==0] <- 0
PS.TSS@sam_data$asca[PS.TSS@sam_data$Ascaridida_asv==0] <- 0
PS.TSS@sam_data$asca[PS.TSS@sam_data$Ascaridida_asv>0] <- 1
### now categories of co-infection
PS.TSS@sam_data$CE_fer[PS.TSS@sam_data$Eimeria_ferrisi_asv>0] <- "ferrisi"
PS.TSS@sam_data$CE_fer[PS.TSS@sam_data$Eimeria_ferrisi_asv==0] <- ""
PS.TSS@sam_data$CE_fal[PS.TSS@sam_data$Eimeria_falciformis_asv>0] <- "falciformis"
PS.TSS@sam_data$CE_fal[PS.TSS@sam_data$Eimeria_falciformis_asv==0] <- ""
PS.TSS@sam_data$CE_ver[PS.TSS@sam_data$Eimeria_vermiformis_asv>0] <- "vermiformis"
PS.TSS@sam_data$CE_ver[PS.TSS@sam_data$Eimeria_vermiformis_asv==0] <- ""
PS.TSS@sam_data$Ccryp[PS.TSS@sam_data$Crypto_asv>0] <- "Cryptosporidium"
PS.TSS@sam_data$Ccryp[PS.TSS@sam_data$Crypto_asv==0] <- ""
PS.TSS@sam_data$Caspi[PS.TSS@sam_data$Aspiculuris_asv==0] <- ""
PS.TSS@sam_data$Caspi[PS.TSS@sam_data$Aspiculuris_asv>0] <- "Aspiculuris"
PS.TSS@sam_data$Csyph[PS.TSS@sam_data$Syphacia_asv>0] <- "Syphacia"
PS.TSS@sam_data$Csyph[PS.TSS@sam_data$Syphacia_asv==0] <- ""
PS.TSS@sam_data$Ctri[PS.TSS@sam_data$Tritrichomonas_asv>0] <- "Tritrichomonas"
PS.TSS@sam_data$Ctri[PS.TSS@sam_data$Tritrichomonas_asv==0] <- ""
PS.TSS@sam_data$Cmas[PS.TSS@sam_data$Mastophorus_asv>0] <- "Mastophorus"
PS.TSS@sam_data$Cmas[PS.TSS@sam_data$Mastophorus_asv==0] <- ""
PS.TSS@sam_data$Ctric[PS.TSS@sam_data$Trichuris_asv>0] <- "Trichuris"
PS.TSS@sam_data$Ctric[PS.TSS@sam_data$Trichuris_asv==0] <- ""
PS.TSS@sam_data$Chymn[PS.TSS@sam_data$Hymenolepis_asv>0] <- "Hymenolepis"
PS.TSS@sam_data$Chymn[PS.TSS@sam_data$Hymenolepis_asv==0] <- ""
PS.TSS@sam_data$Casca[PS.TSS@sam_data$Ascaridida_asv==0] <- ""
PS.TSS@sam_data$Casca[PS.TSS@sam_data$Ascaridida_asv>0] <- "Ascaridida"
PS.TSS@sam_data$Co_inf <- PS.TSS@sam_data$asca+PS.TSS@sam_data$hymn + PS.TSS@sam_data$mas + PS.TSS@sam_data$tri+ PS.TSS@sam_data$syph + PS.TSS@sam_data$aspi + PS.TSS@sam_data$cryp + PS.TSS@sam_data$E_fer + PS.TSS@sam_data$E_ver + PS.TSS@sam_data$E_fal+PS.TSS@sam_data$tric
#summary(as.factor(PS.TSS@sam_data$Co_inf))

PS.TSS@sam_data$Co_infb <- PS.TSS@sam_data$Co_inf
PS.TSS@sam_data$Co_infb[as.numeric(PS.TSS@sam_data$Co_infb)>2] <- 2
...
fPS@sam_data$Co_type <- PS.TSS@sam_data$Co_type
fPS@sam_data$Co_inf <- PS.TSS@sam_data$Co_inf
fPS@sam_data$Co_infb <- PS.TSS@sam_data$Co_infb
fPS@sam_data$CoC_inf <- PS.TSS@sam_data$CCo_inf
